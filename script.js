...
function selectOptions() {
  ...
  function generate() {
    ...
    if (selected === 'capitalize') {
      ...
      output.value = `your middlename start position is ${firstSpace} and last position is ${lastSpace} the middle name is ${splited}`;
      ...
      const replaced = name.replaceAll(length, '*');
      ...
      if (/-/.test(name)) {
        ...
        const beggining = name.substring(0, hyphenIndex);
